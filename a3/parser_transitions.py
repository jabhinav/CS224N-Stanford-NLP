    ...
    def parse_step(self, transition):
        ...
        if transition == "S":
            ...
            if len(self.stack) >= 2:
                ...
                self.dependencies.append((base, dependent))
        elif transition == "RA":
            if len(self.stack) >= 2:
                base = self.stack[-2]
...
def minibatch_parse(sentences, model, batch_size):
    """Parses a list of sentences in mini-batches using a model.
    ...
    while unfinished_parses:
        ...
        for partial_parse, transition in zip(unfinished_parses, transitions):
            partial_parse.parse_step(transition)
            # Stopping Condition - Parse is Completed
